...
from transformers import GPT2ForSequenceClassification, GPT2Tokenizer, GPT2Model, GPT2Config
# from transformers import XLMRobertaTokenizer, XLMRobertaForCausalLM,XLMRobertaModel, XLMRobertaConfig, XLMRobertaForSequenceClassification
# from transformers import RobertaTokenizer, RobertaForCausalLM,RobertaModel, RobertaConfig, RobertaForSequenceClassification
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_steps', type=int, default=2000)  # 最大训练次数
    ...
    # model = AutoModelForMaskedLM.from_pretrained("xlm-roberta-base", num_labels=1)
