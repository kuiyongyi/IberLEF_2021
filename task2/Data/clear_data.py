...
path='/content/drive/MyDrive/IberLEF_HAHA_2021/task2/Data/dev.csv'
data=pd.read_csv(path)
ids = data['id'].tolist()
label = data['humor_rating'].tolist()
...
pd.DataFrame({'id': ids, 'text': duan, 'humor_rating': label}).to_csv(path, index=False)
