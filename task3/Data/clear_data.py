...
path='/content/drive/MyDrive/IberLEF_HAHA_2021/task3/Data/dev.csv'
data=pd.read_csv(path)
ids = data['id'].tolist()
label = data['humor_mechanism'].tolist()
...
pd.DataFrame({'id': ids, 'text': duan, 'humor_mechanism': label}).to_csv(path, index=False)
