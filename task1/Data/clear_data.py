...
path='/content/drive/MyDrive/IberLEF_HAHA_2021/task1/Data0/dev.csv'
data=pd.read_csv(path)
ids = data['id'].tolist()
label = data['is_humor'].tolist()
...
pd.DataFrame({'id': ids, 'text': duan, 'is_humor': label}).to_csv(path, index=False)
